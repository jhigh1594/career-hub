...
| Wants a case-study / portfolio deck for an application | `deck` — multi-slide HTML case-study deck → here.now live URL + PDF; tailored per application; user-gated deploy, never auto-publishes |
