...
.co-src__chip[data-state="active"]{border-color:color-mix(in srgb,var(--color-moss) 45%,transparent)}
.co-src__orb{width:.55rem;height:.55rem;border-radius:50%;background:var(--color-moss);animation:co-orb 1.6s ease-in-out infinite}
.co-src__bar{height:3px;border-radius:2px;background:var(--color-moss);transition:width .4s ease}
...
.co-ledger{display:inline-flex;align-items:center;gap:.5rem;border-radius:999px;border:1px solid color-mix(in srgb,var(--color-moss) 30%,transparent);background:color-mix(in srgb,var(--color-moss) 8%,transparent);color:var(--color-moss);padding:.35rem .85rem;font-size:12.5px;font-weight:600}
@keyframes co-orb{0%,100%{opacity:1}50%{opacity:.35}}
